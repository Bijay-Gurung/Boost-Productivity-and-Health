...
class _ForgotPasswordScreenState extends State<ForgotPassword> {
  ...
  Future<void> _sendOTP() async {
    final url = Uri.parse('http://10.22.31.110:4000/forgot-password'); 
...
class _VerifyOTPScreenState extends State<VerifyOTP> {
  ...
  Future<void> _verifyOTP() async {
    final url = Uri.parse('http://10.22.31.110:4000/forgot-password/verify-otp');
...
class _ResetPasswordScreenState extends State<ResetPassword> {
  ...
  Future<void> _resetPassword() async {
    final url = Uri.parse('http://10.22.31.110:4000/forgot-password/reset-password');
